export default [
    {
        ...
        colors: [
            ...
            {id: 'deeporange', name: "deeporange", color: "#FF5722" },
            {id: 'brown', name: "brown", color: "#795548" },
            {id:'grey', name: "grey", color: "#9E9E9E" },
            {id: 'bluegrey',  name: "bluegrey", color: "#607D8B" }
        ]
    },
    {
        ...
        emoji: "🤙",
        colors: [
            {id:'Turquoise', name: "Turquoise", color: "#1abc9c" },
            {id:'Emerald', name: "Emerald", color: "#2ecc71" },
            {id:'PeterRiver', name: "PeterRiver", color: "#3498db" },
            {id:'Amethyst', name: "Amethyst", color: "#9b59b6" },
            {id:'WetAsphalt', name: "WetAsphalt", color: "#34495e" },
            {id:'GreenSea', name: "GreenSea", color: "#16a085" },
            {id:'Nephritis', name: "Nephritis", color: "#27ae60" },
            {id:'BelizeHole', name: "BelizeHole", color: "#2980b9" },
            {id:'Wisteria', name: "Wisteria", color: "#8e44ad" },
            {id:'MidnightBlue', name: "MidnightBlue", color: "#2c3e50" },
            {id:'SunFlower', name: "SunFlower", color: "#f1c40f" },
            {id:'Carrot', name: "Carrot", color: "#e67e22" },
            {id:'Alizarin', name: "Alizarin", color: "#e74c3c" },
            {id:'Clouds', name: "Clouds", color: "#ecf0f1" },
            {id:'Concrete', name: "Concrete", color: "#95a5a6" },
            ...
            {id:'Asbestos', name: "Asbestos", color: "#7f8c8d" }
        ]
    },
    {
        ...
        emoji: "🇳🇱",
        colors: [
            {id:'Sunflower', name: "Sunflower", color: "#FFC312" },
            {id:'Energos', name: "Energos", color: "#C4E538" },
            {id:'BlueMartina', name: "BlueMartina", color: "#12CBC4" },
            {id:'LavenderRose', name: "LavenderRose", color: "#FDA7DF" },
            {id:'BaraRose', name: "BaraRose", color: "#ED4C67" },
            {id:'RadiantYellow', name: "RadiantYellow", color: "#F79F1F" },
            {id:'AndroidGreen', name: "AndroidGreen", color: "#A3CB38" },
            {id:'MediterraneanSea', name: "MediterraneanSea", color: "#1289A7" },
            {id:'LavenderTea', name: "LavenderTea", color: "#D980FA" },
            {id:'VerryBerry', name: "VerryBerry", color: "#B53471" },
            {id:'PuffinsBill', name: "PuffinsBill", color: "#EE5A24" },
            {id:'PixelatedGrass', name: "PixelatedGrass", color: "#009432" },
            {id:'MerchantMarineBlue', name: "MerchantMarineBlue", color: "#0652DD" },
            {id:'ForgottenPurple', name: "ForgottenPurple", color: "#9980FA" },
            {id:'HollyHock', name: "HollyHock", color: "#833471" },
            {id:'RedPigment', name: "RedPigment", color: "#EA2027" },
            {id:'TurkishAqua', name: "TurkishAqua", color: "#006266" },
            {id:'2000LeaguesUnderTheSea', name: "20000LeaguesUnderTheSea", color: "#1B1464" },
            {id:'CircumorbitalRing', name: "CircumorbitalRing", color: "#5758BB" },
            {id:'MagentaPurple', name: "MagentaPurple", color: "#6F1E51" }
        ]
    }
    // ,
    // {
